...
public class YanchuxinxiOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YanchuxinxiOrderEntity() {

	}

	public YanchuxinxiOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "YanchuxinxiOrder{" +
            "id=" + id +
            ", yanchuxinxiOrderUuidNumber=" + yanchuxinxiOrderUuidNumber +
            ", yanchuxinxiId=" + yanchuxinxiId +
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", yanchuxinxiOrderTruePrice=" + yanchuxinxiOrderTruePrice +
            ", yanchuxinxiOrderTypes=" + yanchuxinxiOrderTypes +
