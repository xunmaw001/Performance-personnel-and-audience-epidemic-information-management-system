var projectName = '演出人员与观众疫情信息管理系统';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '购票订单',
        url: '../yanchuxinxiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '演出信息',
        url: './pages/yanchuxinxi/list.html'
    },

]

var adminurl =  "http://localhost:8080/yanchurenyuanyugguanzhong/admin/dist/index.html#/login";
